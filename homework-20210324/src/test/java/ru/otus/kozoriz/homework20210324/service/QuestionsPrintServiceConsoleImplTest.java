...
@DisplayName("Класс QuestionsPrintServiceConsoleImpl")
class QuestionsPrintServiceConsoleImplTest {
    ...
    QuestionsPrintServiceConsoleImpl printService;

    @BeforeEach
    void setUp() {
        printService = new QuestionsPrintServiceConsoleImpl();
    }
